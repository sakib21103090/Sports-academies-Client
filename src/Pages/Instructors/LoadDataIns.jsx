...
const LoadDataIns = ({instructor}) => {
    ...
    <div className="card-body text-black ">
      <h2> <span className='font-bold text-2xl text-black '>Name: </span>{instructorName}</h2>
      <p className='text-primary-color'> <span className='font-bold text-black '>Email:</span>{instructorEmail}</p>
