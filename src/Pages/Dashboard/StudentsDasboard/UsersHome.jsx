...
const UsersHome = () => {
    ...
    return (
      <div className='pt-28  max-w-sm mx-auto'>
        <div>
          <h1 className='font-bold text-lime-600 text-3xl mb-6 font-serif'>User Information</h1>
        </div>
        <div>
         {user && <img className='rounded-xl w-[100px] border-4 border-blue-500  mx-auto mb-6' src={user.photoURL}  /> }  
          <h2 className=' text-center text-black'><span className='font-bold text-lime-600'> Name:</span>{user.displayName}</h2>
